...
if dataset == 'sysu':
    data_path = 'D:/2021/Code/SYSU-MM01/'
    log_path = args.log_path + 'sysu_log/'
    test_mode = [1, 2]  # thermal to visible
elif dataset == 'regdb':

    data_path = 'D:/2021/Code/RegDB/'
...
suffix = dataset+'_rerank{}_re_pcb_{}_wc{}'.format(args.re_rank, args.pcb, args.w_center)
if args.pcb=='on':
...
our_method = 'HC_SSL'
print("==> This time the method is : ", our_method)
if dataset == 'sysu':
    suffix = suffix + '_{}mode_{}'.format(args.mode, our_method)
...
for epoch in range(start_epoch, 101 if args.dataset == 'regdb' else 101  - start_epoch):
